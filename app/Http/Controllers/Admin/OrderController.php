...
class OrderController extends Controller
{
    ...
    {
        $order = Order::with(['sender', 'traveler'])->findOrFail($id);
        $users = User::all(); 
        $flightDetails = FlightDetail::where('user_id', $order->traveler_id)->first();
        return view('admin-views.order.order-view', compact('order', 'users', 'flightDetails'));
    }
