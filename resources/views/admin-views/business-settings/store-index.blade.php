    ...
    <div class="row gx-2 gx-lg-3">
        <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
            <form action="{{route('admin.business-settings.update-setup')}}" method="post" enctype="multipart/form-data">
                @csrf
                @php
                    $nameSetting = \App\Model\BusinessSetting::where('key', 'store_name')->first();
                    $name = $nameSetting ? $nameSetting->value : '';
                @endphp
                ...
                <div id="timeRangeContainer">
                    ...
                    @php
                        $openingHoursSetting = \App\Model\BusinessSetting::where('key', 'store_open_time')->first();
                        $defaultOpeningHours = [['start' => '09:00', 'end' => '17:00']];
                        $openingHoursArray = $openingHoursSetting ? json_decode($openingHoursSetting->value, true) : $defaultOpeningHours;
                        $openingHoursArray = is_array($openingHoursArray) ? $openingHoursArray : $defaultOpeningHours;
                    @endphp
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        @php($ev2=\App\Model\BusinessSetting::where('key','phone')->first()->value)
                        <div class="form-group">
                    ...
                    <div class="col-md-6 col-12">
                        @php($closed=\App\Model\BusinessSetting::where('key','store_close_time')->first()->value)
                        <div class="form-group">
