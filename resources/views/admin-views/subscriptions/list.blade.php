        ...
        <div class="page-header">
            <div class="row align-items-center mb-3">
                <div class="card-header">
                    ...
                    <a href="{{route('admin.subscription.add-new')}}" class="btn btn-primary pull-right"><i
                    class="tio-add-circle"></i> {{trans('messages.add')}} {{trans('messages.new')}} {{trans('messages.Subscriptions')}}</a>
                </div>
            </div>
            <!-- End Row -->
            ...
            <span class="hs-nav-scroller-arrow-prev" style="display: none;">
              ...
              <a class="hs-nav-scroller-arrow-link" href="javascript:;">
                ...
                <ul class="nav nav-tabs page-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" href="#">{{trans('messages.Subscriptions')}}</a>
                    </li>
                </ul>
                <!-- End Nav -->
            </div>
                    ...
                    <tbody id="set-rows">
                        @foreach($subscriptions as $subscription)
                            <tr>
                                ...
                                <td>{{ $subscription->user->f_name }} {{ $subscription->user->l_name }}</td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button class="btn btn-outline-secondary dropdown-toggle" type="button"
                                                id="dropdownMenuButton{{ $subscription->id }}" data-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                            <i class="tio-settings"></i>
                                        </button>
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $subscription->id }}">
                                        <a class="dropdown-item" href="{{ route('admin.subscription.edit', ['id' => $subscription->id]) }}">
                                            <i class="tio-visible"></i> {{ trans('messages.edit') }}
                                        </a>

                                        <a class="dropdown-item" href="{{ route('admin.subscription.delete', ['id' => $subscription->id]) }}" onclick="event.preventDefault(); document.getElementById('delete-form{{ $subscription->id }}').submit();">
                                            <i class="tio-delete"></i> {{ trans('messages.delete') }}
                                        </a>
                                        <form id="delete-form{{ $subscription->id }}" action="{{ route('admin.subscription.delete', ['id' => $subscription->id]) }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                        </div>
