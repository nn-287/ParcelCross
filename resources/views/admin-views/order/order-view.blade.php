                        ...
                        <div class="card-body">
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Sender:</th>
                                        <td>{{ $order->sender->f_name }} {{ $order->sender->l_name }}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>User status:</th>
                                        <td>{{ $order->sender->user_type }}</td>
                                    </tr>

                                    <tr>
                                        <th>More details:</th>
                                        <td>{{ $order->sender->identity_number }}</td>
                                        <td>{{ $order->sender->identity_image }}</td>
                                    </tr>

                                    <tr>
                                        <th>Traveler ID:</th>
                                        <td>{{ $order->traveler_id }}</td>
                                    </tr>
                                <tr>
                                    <th>Traveler:</th>
                                    <td>{{ $order->traveler->f_name }} {{ $order->traveler->l_name }}</td>
                                </tr>

                                <tr>
                                    <th>Phone:</th>
                                    <td>{{ $order->traveler->phone }}</td>
                                </tr>

                                <tr>
                                    <th>Email:</th>
                                    <td>{{ $order->traveler->email }}</td>
                                </tr>

                                <tr>
                                    <th>User Type:</th>
                                    <td>{{ $order->traveler->user_type }}</td>
                                </tr>

                                <tr>
                                    <th>Identity Number:</th>
                                    <td>{{ $order->traveler->identity_number }}</td>
                                </tr>

                                <tr>
                                    <th>Identity Image:</th>
                                    <td>{{ $order->traveler->identity_image }}</td>
                                </tr>

                                <tr>
                                    <th>Pickup insights:</th>
                                    <td>{{ $order->pickup_latitude }}, {{ $order->pickup_longitude }}</td>
                                </tr>

                                <tr>
                                    <th>Destination insights:</th>
                                    <td>{{ $order->destination_country }}, {{ $order->destination_city }}</td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="7">
                                        Flight departure time: {{ $flightDetails->departure_time }}
                                    </td>

                                    <td colspan="7">
                                        Flight arrival time: {{ $flightDetails->arrival_time }} 
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="7">
                                        Flight departure country: {{ $flightDetails->departure_country }} 
                                    </td>

                                    <td colspan="7">
                                        Flight departure city: {{ $flightDetails->departure_city }} 
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="7">
                                        Flight destination country: {{ $flightDetails->destination_country }} 
                                    </td>

                                    <td colspan="7">
                                        Flight destination city: {{ $flightDetails->destination_city }} 
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="7">
                                        Flight last issued at: {{ $flightDetails->created_at }}
                                    </td>

                                    <td colspan="7">
                                        Flight last updated at: {{ $flightDetails->updated_at }}
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <th>Flight Details:</th>
                                    <td colspan="6">No flight details found for this traveler.</td>
                                </tr>
                                @endif
