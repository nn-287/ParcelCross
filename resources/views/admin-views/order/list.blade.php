                            ...
                            <div id="showHideDropdown" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right dropdown-card" style="width: 15rem;">
                                <div class="card card-sm">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <span class="mr-2">{{trans('messages.Traveler_id')}}</span>
            ...
            <table id="datatable" class="table  table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table" style="width: 100%" data-hs-datatables-options='{
                   ...
                   <thead class="thead bg-dark-grey border-secondary text-white">
                        <tr>
                            ...
                            <th id="column-traveler">{{trans('messages.Traveler_id')}}</th>
                            <th id="column-issue-date">{{trans('messages.Issue_date')}}</th>
                ...
                <tbody id="set-rows">
                    ...
                    <tr class="status-{{$order['order_status']}} class-all">
                        ...
                        <td class="text-white-50">{{date('d M Y',strtotime($order['created_at']))}}</td>
